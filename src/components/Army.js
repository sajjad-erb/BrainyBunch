  ...
  return (
    <div className='mx-[8%] tracking-widest'>
      <div className='w-[80%]'>
        ...
        <p className='mt-6 text-xl font-light'><span className='text-5xl'>But that's not all, </span>Our <span className='text-green-650'>premium commanders</span> and <span className='text-pink-650'>sail warriors </span> , such as CTOs and Senior Devs, bring a full-stack of expertise to the table.</p>
      </div>
    </div>
  )
}
