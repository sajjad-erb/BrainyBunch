...
const RoyalCouncil = () => {
    return (
        <div className='mx-[8%]'>
            <h1 className='text-7xl double-brush-effect'>Royal council</h1>
            <p className='text-xl mt-6 w-[60%] font-light'>Allow us to present to you, the notable 'Brainy Bunch' council members. Their expertise and skills shall speak for themselves.
            </p>
            <div className='grid grid-cols-12 gap-24  items-center mt-24'>
