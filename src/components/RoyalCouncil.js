...
const RoyalCouncil = () => {
    return (
        <div className='mx-[8%]'>
            ...
            <div className='grid  md:grid-cols-3 lg:grid-cols-3 gap-24 lg:items-center  mt-24'>
                <div className='px-4 md:px-0'>
                    <div className='relative flex justify-center '>
                        <img src="lord-smith council.svg" alt="interviews for hiring web developer" className='md:h-[330px]' />
                ...
                <div className='px-4 md:px-0'>
                    <div className='relative flex justify-center'>
                        <img src="lady-jones council.svg" alt="communication skills check" className='height-lady md:h-[330px]' />
                ...
                <div className='px-4 md:px-0 '>
                    <div className='relative flex justify-center'>
                        <img src="dragon council.svg" alt="" className='height-dragon md:h-[330px]' />
                        <img src="haaaa.svg" alt="Dragon shouting HAAA He finds every field of software engineers" className='absolute top-0 h-[20%] right-0' />
                    </div>
