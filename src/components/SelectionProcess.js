...
const SelectionProcess = () => {
    return (
        <div className='mx-[8%] tracking-widest'>
            <h1 className='text-7xl w-[70%] font-bold '> The Imperial <span className='brushed-background'> Selection Process </span> of our Knights </h1>
            <div className='grid grid-cols-2 gap-x-40 gap-y-36'>
                <div className='mt-24'>
                    <div className='h-100 bg-black-650 shadow-outline-white '>
                        <div className=' p-[10%] border-2 border-green-650  -rotate-1 hover:rotate-1 '>
                            ...
                            <h5 className='text-3xl double-brush-effect'>The Resume Evaluation</h5>
                ...
                <div className='mt-24'>
                    <div className='h-100 bg-black-650 shadow-outline-white '>
                        <div className=' p-[10%] border-2 border-pink-650  rotate-1 hover:-rotate-1'>
                            ...
                            <h5 className='text-3xl double-brush-effect'>Communication skills </h5>
                ...
                <div className='h-100 bg-black-650 shadow-outline-white '>
                    <div className=' p-[10%] border-2 border-pink-650  -rotate-1 hover:rotate-1'>
                        ...
                        <h5 className='text-3xl double-brush-effect'>The Skills Evaluation</h5>
                ...
                <div className='h-100 bg-black-650 shadow-outline-white '>
                    <div className=' p-[10%] border-2 border-green-650  rotate-1 hover:-rotate-1'>
                        ...
                        <h5 className='text-3xl double-brush-effect'>The Final Interview</h5>
                        <p className='text-xl font-light'>Finally, Lord Smith will hold a last interview with the candidate to assess their passion and motivation for the startup hustle and their work.
                        </p>
                    </div>
                </div>
            </div>
