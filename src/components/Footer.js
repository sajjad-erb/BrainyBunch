...
const Footer = () => {
    return (
        <>
            <footer class=" tracking-widest">
                <div class="grid grid-cols-12 container mx-auto px-4 items-start pt-10">
                    <div class="md:col-span-6 col-span-12 pb-10 ">
                        <img src="logo.svg" alt="" />
                        <div><span class="text-white mt-2 text-lg"></span></div>
                        <div class="flex pb-10 pt-10">
                            <a class="cursor-pointer" href="https://www.facebook.com/softaims/">
                            ...
                            <a class="mx-2 cursor-pointer" href="https://www.facebook.com/softaims/">
                                <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="md:col-span-3 col-span-12 mt-7">
                        <h5 class="text-uppercase font-semibold text-white text-2xl ">Company</h5>
                        <ul class="list-unstyled md:mt-10 mt-5">
                            <li>
                                <a href="https://thesoftaims.com/" class=" text-lg text-white">Website</a>
                            </li>
                            <li>
                                <a href="https://thesoftaims.com/team" class=" text-lg text-white ">About The Team</a>
                            </li>
                            <li>
                                <a href="https://thesoftaims.com/location" class="text-lg text-white">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="md:col-span-3 col-span-12 mt-7 pb-5 md:pb-0">
                        <h5 class="text-uppercase font-semibold text-white text-2xl mt-4 md:mt-0">Legal</h5>

                        <ul class="list-unstyled md:mt-10 mt-5">
                            <li>
                                <a href="/privacy" class="text-lg text-white">Privacy</a>
                            </li>
                            <li>
                                <a href="/terms_conditions" class="text-lg text-white">Terms</a>
                            </li>
                            <li>
                                <a href="/cookies_policy" class="text-lg text-white">Cookies</a>
                            </li>

                        </ul>
                    </div>
                </div>
                <div class="text-center p-3 text-white bg-blue-650">
