    ...
    return (
        <>
            <footer className=" tracking-widest">
                <div className='md:flex justify-between  gap-5 px-16 mb-7 '>
                    <div className='first'>
                        <div className="md:col-span-5">
                            <div className='flex mt-5 justify-center item-center'>
                                ...
                                <div className='flex items-center ml-2 text-xl text-center lg:ml-5 lg:text-3xl lg:mt-3'>
                                    <p>
                                        BRAINY BUNCH
                                    </p>
                                </div>
                            </div>
                            <div className='mt-2 lg:mt-2 text-sm text-center lg:text-left'>
                                <a href="" className='mt-6'>hello@brainbunch.io</a>
                            </div>
                        </div>
                    </div>
                    <div className='md:flex gap-10 second'>

                        <div className='flex gap-5 justify-between lg:justify-center'>
                            <div className="md:col-span-6  mt-7 ">
                                <h5 className="text-uppercase font-semibold text-[#66C41E] text-base lg:text-2xl">Company</h5>
                                <ul className="list-unstyled md:mt-10 mt-5">
                                    <li>
                                        <a href="https://thesoftaims.com/" className=" text-sm text-white">Website</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/team" className=" text-sm text-white ">Team</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/location" className="text-sm text-white">Contact Us</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="md:col-span-6  md:mt-7 mt-4">
                                <h5 className="text-uppercase font-semibold  text-[#66C41E] text-base lg:text-2xl mt-4 md:mt-0">Legal</h5>

                                <ul className="list-unstyled md:mt-10 mt-5">
                                    <li>
                                        <a href="/privacy" className="text-sm text-white">Privacy</a>
                                    </li>
                                    <li>
                                        <a href="/terms_conditions" className="text-sm text-white">Terms</a>
                                    </li>
                                    <li>
                                        <a href="/cookies_policy" className="text-sm text-white">Cookies</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className='flex gap-5  justify-center'>
                            <div className="md:col-span-6  mt-7">
                                <h5 className="text-uppercase font-semibold  text-[#66C41E] text-base lg:text-2xl">Resources</h5>
                                <ul className="list-unstyled md:mt-10 mt-5">
                                    <li>
                                        <a href="https://thesoftaims.com/" className=" text-sm text-white">Blog</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/team" className=" text-sm text-white ">Docs</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/location" className="text-sm text-white">Security</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="md:col-span-6 mt-7">
                                <h5 className="text-uppercase font-semibold  text-[#66C41E] text-base lg:text-2xl ">Tools</h5>
                                <ul className="list-unstyled md:mt-10 mt-5">
                                    <li>
                                        <a href="https://thesoftaims.com/" className=" text-sm text-white">Altium</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/team" className=" text-sm text-white ">Eagle</a>
                                    </li>
                                    <li>
                                        <a href="https://thesoftaims.com/location" className="text-sm text-white">Security</a>
                                    </li>
                ...
                <div className='border-t mx-14'>
                    ...
                    <div className=' justify-center bg-blue-650  flex md:justify-between p-3 text-center text-white '>
                        <div className='md:flex hidden items-center gap-2'>
                            <img src="copyright.svg"
                                alt="logo of copyright"
                            />
                            <p>
                                2022 All rights reserved.
                            </p>
                            <div className='flex md:text-sm  gap-2'>
